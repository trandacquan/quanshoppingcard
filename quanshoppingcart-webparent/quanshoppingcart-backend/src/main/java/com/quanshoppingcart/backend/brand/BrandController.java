package com.quanshoppingcart.backend.brand;
...
public class BrandController {
	...
	@GetMapping("/brands/new/category/{id}")
	public String addNewCategoryInBrandForm(@PathVariable(name = "id") Integer brandId, Model model) {
		List<Category> listCategories=categoryService.listCategoriesUsedInForm();
		...
		return "categories/category_modal";
	}
	
	/*Hàm lưu category mới từ Brand Form*/
	@PostMapping("/categories/save/modalForm/{id}")
