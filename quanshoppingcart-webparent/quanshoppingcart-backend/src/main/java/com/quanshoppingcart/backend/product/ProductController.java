...
import com.quanshoppingcart.backend.category.CategoryService;
import com.quanshoppingcart.backend.security.ShoppingUserDetails;
...
public class ProductController {
	...
	private String defaultRedirectURL = "redirect:/products/page/1?sortField=name&sortDir=asc&categoryId=0";// đường dẫn
																											// mặc định
